...
public class Check_AppVersionAsyncTask extends AsyncTask<Void, Void, HashMap<String, String>> {
    HashMap<String, String> param = new HashMap<String, String>();
    OnCompletionListner onCompletionListner = null;

    public Check_AppVersionAsyncTask(HashMap<String, String> param, OnCompletionListner onCompletionListner) {
        this.param = param;
    ...
    @Override
        protected HashMap<String, String> doInBackground(Void... params) {
            ...
            try {
                responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.Check_AppVersion), param);
                result = ParseJSON.parseCheck_AppVersionJson(responseString);
            } catch (Exception e) {
