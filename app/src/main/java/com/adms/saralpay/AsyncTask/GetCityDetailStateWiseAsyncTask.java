...
public class GetCityDetailStateWiseAsyncTask extends AsyncTask<Void, Void, ArrayList<String>> {
    HashMap<String, String> param = new HashMap<String, String>();
    OnCompletionListner onCompletionListner;

    public GetCityDetailStateWiseAsyncTask(HashMap<String, String> param, OnCompletionListner onCompletionListner) {
        this.param = param;
    ...
    @Override
        ...
        ArrayList<String> result = null;
            try {
                responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetCityDetailStateWise), param);
                result = ParseJSON.parseCityJson(responseString);
            } catch (Exception e) {
