...
public class UpgradeCustomerStatusAsyncTask extends AsyncTask<Void, Void, HashMap<String, String>> {
    HashMap<String, String> param = new HashMap<String, String>();
    OnCompletionListner onCompletionListner = null;

    public UpgradeCustomerStatusAsyncTask(HashMap<String, String> param, OnCompletionListner onCompletionListner) {
        this.param = param;
    ...
    @Override
        protected HashMap<String, String> doInBackground(Void... params) {
            ...
            try {
                responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.UpgradeCustomerStatus), param);
                result = ParseJSON.parseUpgradeCustomerStatusJson(responseString);
            } catch (Exception e) {
