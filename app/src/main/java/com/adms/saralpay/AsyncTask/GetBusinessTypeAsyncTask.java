...
public class GetBusinessTypeAsyncTask extends AsyncTask<Void, Void, HashMap<String, String>> {
    HashMap<String, String> param = new HashMap<String, String>();
    OnCompletionListner onCompletionListner;

    public GetBusinessTypeAsyncTask(HashMap<String, String> param, OnCompletionListner onCompletionListner) {
        this.param = param;
    ...
    @Override
        protected HashMap<String, String> doInBackground(Void... params) {
            ...
            try {
                responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetBusinessType), param);
                result = ParseJSON.parseGetBusinessTypeJson(responseString);
            } catch (Exception e) {
